...
import {
  Box, Avatar, Typography, Stack, IconButton, Tooltip,
  TextField, Button, Chip, List, ListItem, ListItemText, CircularProgress,
  Dialog, DialogTitle, DialogContent, useMediaQuery, Menu, MenuItem
} from '@mui/material'
    ...
    return (
      ...
      >
        <Stack direction="row" spacing={1.5} alignItems="flex-start">
          <Avatar sx={{ bgcolor: 'primary.main', fontWeight: 600, width: 36, height: 36, fontSize: 13 }}>
      ...
      <Stack direction="row" spacing={{ xs: 1.25, md: 2 }} alignItems="flex-start">
        <Avatar 
          ...
          sx={{ 
            ...
            '&:hover': onAuthorClick && authorId ? { opacity: 0.85 } : {}
          }}
          onClick={(e) => {
                  ...
                  >
                    <Box
                      ...
                      sx={{ 
                        ...
                        mx: 'auto',
                        display: 'block',
                        filter: 'drop-shadow(0 4px 12px rgba(10,102,194,0.15))'
                      }}
                    />
