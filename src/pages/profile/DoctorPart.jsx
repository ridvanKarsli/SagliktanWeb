...
function AddSpecializationForm({ onAdded, onClose }) {
  ...
  return (
    <Box
      ...
      sx={{ mt: 2, p: 2, borderRadius: 1.5, bgcolor: 'background.paper' }}
    >
      <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ mb: 1.5 }}>
        <Typography variant="subtitle2" fontWeight={600}>Uzmanlık Ekle</Typography>
...
function AddAddressForm({ onAdded, onClose }) {
  ...
  return (
    ...
    >
      <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ mb: 1.5 }}>
        <Typography variant="subtitle2" fontWeight={600}>Adres Ekle</Typography>
        <Button size="small" onClick={onClose} variant="text">Kapat</Button>
      </Stack>
...
function AddContactForm({ onAdded, onClose }) {
  ...
  return (
    ...
    >
      <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ mb: 1.5 }}>
        <Typography variant="subtitle2" fontWeight={600}>İletişim Ekle</Typography>
        <Button size="small" onClick={onClose} variant="text">Kapat</Button>
      </Stack>
...
function AddAnnouncementForm({ onAdded, onClose }) {
  ...
  return (
    ...
    >
      <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ mb: 1.5 }}>
        <Typography variant="subtitle2" fontWeight={600}>Duyuru Ekle</Typography>
        <Button size="small" onClick={onClose} variant="text">Kapat</Button>
      </Stack>
